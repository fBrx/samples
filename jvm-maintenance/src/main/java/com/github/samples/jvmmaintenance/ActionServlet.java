...
public class ActionServlet extends HttpServlet {
    ...
    /**
     * Evaluates the {@link ActionServlet#OPERATION_PARAM} request parameter and performs the corresponding operations. The response is then redirected to "/" which causes the default welcome page to
     * be opened.
     * 
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        else if (operation != null && (operation.equals(ACTION_JAVADUMPIBM) || operation.equals(ACTION_HEAPDUMPIBM) || operation.equals(ACTION_SYSTEMDUMPIBM)))
    ...
    private void generateIbmDump(String operation) {
        ...
        try {
            ...
            if (operation.equals(ACTION_JAVADUMPIBM)) javaDump.invoke(null, (Object[]) null);
            if (operation.equals(ACTION_HEAPDUMPIBM)) heapDump.invoke(null, (Object[]) null);
            if (operation.equals(ACTION_SYSTEMDUMPIBM)) systemDump.invoke(null, (Object[]) null);
